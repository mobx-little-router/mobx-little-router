...
describe('TransitionGroup', () => {
  ...
  test('TransitionGroup handles transitioning in and out of routes', async () => {
    ...
    expect(tracker.to && tracker.to.model.transitionState).toBe('entering')
    ...
    expect(tracker.to && tracker.to.model.transitionState).toBe('entered')
    ...
    // Then the animation is initialized with the active class
    expect(to && to.model.transitionState).toBe('entering')
    expect(from && from.model.transitionState).toBe('exiting')
    ...
    expect(to && to.model.transitionState).toBe('entered')
    expect(from && from.model.transitionState).toBe('exited') // This doesnt get set properly for non animated routes
